...
class TestAndroid(TestBase):
    ...
    def setUpClass(cls):
        super().setUpClass()
        print(">>> Setting up TestAndroid class")
    ...
    def test_FTUE(self):
        ...
        time.sleep(5)
        #assert self.overlay_page.text_Beating() == 'You are beating <color=#FFC107> 19.08% </color> of other players!'
        time.sleep(2)
    ...
    def test_events_leaderboard_settings(self):
        ...
        self.overlay_page.btn_reward_claim_close()
        self.overlay_page.btn_rating_no_thanks()
        self.overlay_page.btn_noThanks()

        time.sleep(4)
        self.overlay_page.tab_leaderboard()
    ...
    def test_android_settings_quit(self):
        time.sleep(3)
        self.main_page.home_tab()
    ...
    def test_puzzel_tab(self):
        ...
        self.start_page.btn_reward_close_game()
        self.start_page.puzzel_hand_game()
        self.overlay_page.btn_pet_1()
        self.overlay_page.btn_pet_1_select()
        time.sleep(3)
        ...
        time.sleep(8)
        self.overlay_page.button_fail_close()
        self.start_page.btn_navigation_pet()
        self.overlay_page.btn_pet_1()
        self.overlay_page.btn_pet_1_select()
        self.overlay_page.btn_pet_equip()
        self.overlay_page.button_fail_close()
        sizeX = self.start_page.grid_size()[0]
        sizeY = self.start_page.grid_size()[1]
        gridColours = [int(x) for x in self.start_page.color_grid()]
    ...
    def test_hard_level(self):
        ...
        time.sleep(3)
       # assert self.overlay_page.msg_treasure_Event()
        time.sleep(4)
        self.overlay_page.btn_reward_claim_close()
        time.sleep(4)
        #self.overlay_page.msg_treasure_Event_success()
        time.sleep(3)
        ...
        # assert self.overlay_page.text_rewards_puzzel() == 6
