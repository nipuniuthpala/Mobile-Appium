...
## Run the test:
echo "Running tests"
#python -m pytest tests/android_test.py::TestAndroid -s --alluredir=allure-results --html=reports/${APP_NAME}_report.html --self-contained-html

python -m pytest tests/android_test.py::TestAndroid -s --alluredir=allure-results --html=reports/${APP_NAME}_report.html --self-contained-html
python -m pytest tests/android_analytics_test.py::TestAndroidAnalytics -s --alluredir=allure-results --html=reports/${APP_NAME}_analytics_report.html --self-contained-html
