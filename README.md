Info about the required setup and how to run these tests can be found here: This should include properly setting up Appium server too.
...
4. `./run_tests_android.sh "46-BS05-QueensPuzzle-alt_test_build-v1.6.0.3511-30770058f-UAT.apk" "com.kwalee.queenspuzzle" "queens" "com.unity3d.player.UnityPlayerActivity"
` command in your terminal we need to pass apk game package name game name and app activity 
